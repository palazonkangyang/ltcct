...
<body class="A5 landscape">
		  ...
		  <div id="leftcontent">
		    ...
		    <div class="receipt-info">
		      ...
		      <div class="label-wrapper" style="font-weight: bold;">
		        ...
		        <div class="label-right">消灾</div><!-- end label-right -->
		      </div><!-- end label-wrapper -->
		  ...
		  <div id="rightcontent">
		    ...
		    <div class="receipt-info">
		      ...
		      <div class="label-rightwrapper" style="font-weight: bold">
		        ...
		        <div class="rightlabel-right">消灾</div><!-- end label-right -->
		      </div><!-- end label-wrapper -->
		    </div><!-- end receipt-info -->
  ...
  @endfor
	...
	@php $loop = count($receipts) - $devotee_count;  dd($devotee_count); @endphp
      ...
      <div class="receipt-list">
        ...
        <table class="receipt-table">
          ...
          <tbody>
						...
						@for($i = $devotee_count; $i < 2; $i++)

						@php dd($devotee_count); @endphp
						...
						@php $devotee_count++; $rowno++;  $sum += $receipts[$i]->amount; @endphp
