<div class="form-body">
  ...
  <form method="post" target="_blank" action="{{ URL::to('/fahui/qifu-reprint-detail') }}"
  ...
  <div class="col-md-6">
    ...
    <div class="form-group">
      ...
      <div class="col-md-4">
        <button type="button" class="btn default" id="qifu_search_detail">Detail</button>
      </div><!-- end col-md-4 -->
    </div><!-- end form-group -->
  ...
  <div class="col-md-12" id="qifu_trans_wrap1">
    <div class="form-group">
      <br />
  ...
  <div class="col-md-12" id="qifu_trans_wrap2">
  ...
  <div class="col-md-12" id="qifu_trans_wrap3">
  ...
  <div class="col-md-12" id="qifu_trans_wrap4">
    <p class="text-center text-danger" id="transaction-text">

    </p>
  </div><!-- end col-md-12 -->

  <div class="col-md-12" id="qifu_trans_wrap5">
    <div class="form-group">
  ...
  <div class="col-md-12" id="qifu_trans_wrap6">
    <div class="form-group">
...
<form method="post" action="{{ URL::to('/fahui/qifu-cancel-transaction') }}"
  class="form-horizontal form-bordered" id="">
  {!! csrf_field() !!}

  <div class="col-md-12" id="qifu_trans_wrap7">
    <br />
    <div class="form-group">
  ...
  <div class="col-md-12" id="qifu_trans_wrap8">
   ...
   @if(Auth::user()->role != 5)
    ...
    <div class="form-group">
      <div class="form-actions">
       <button type="button" class="btn blue" id="cancel-qifu-replace-btn">Cancel & Replace Transaction</button>
       <button type="submit" class="btn default" id="cancel-qifu-transaction">Cancel Transaction</button>
    ...
    <div class="form-group">
      <div class="form-actions">
       <button type="button" class="btn blue" id="cancel-qifu-replace-btn" disabled>Cancel & Replace Transaction</button>
       <button type="submit" class="btn default" id="cancel-qifu-transaction" disabled>Cancel Transaction</button>
     </div><!-- end form-actions -->
    </div><!-- end form-group -->
